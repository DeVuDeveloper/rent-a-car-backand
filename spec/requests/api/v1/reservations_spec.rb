  ...
  path '/api/v1/reservations' do
    post 'Create Reservations' do
      ...
      parameter name: :reservation, in: :body, schema: {
        type: :object,
        properties: {
          pick_up_date: { type: 'string', format: 'date', required: true },
          drop_off_date: { type: 'string', format: 'date', required: true },
          pick_up_city: { type: :string },
          return_city: { type: :string }
        },
        required: %w[pick_up_date drop_off_date pick_up_city return_city]
      }
      ...
      response '401', 'reservation created' do
        ...
        let(:reservation) do
          { car_id: 7, pick_up_date: '2022-06-07', drop_off_date: '2022-06-17', pick_up_city: 'Paris',
